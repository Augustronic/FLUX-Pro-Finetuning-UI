...
def create_app():
    ...
    with gr.Blocks(title="FLUX Pro Finetuning UI") as app:
        ...
        <div style="text-align: center; margin: 0 auto; padding: 0 2rem;">
            <h1 style="font-size: 2.5rem; font-weight: 600; margin: 1rem 0; color: lightgreen;">FLUX Pro Finetuning UI</h1>
        ...
        with gr.Tabs() as tabs:
            with gr.Tab("Finetune Model"):
                ...
                <div style="text-align: center; margin: 1rem 0;">
                    <h2 style="font-size: 1.8rem; font-weight: 600; color: green;">Model Finetuning</h2>
            ...
            with gr.Tab("Model Browser"):
                gr.Markdown(
                    """
                <div style="text-align: center; margin: 1rem 0;">
                    <h2 style="font-size: 1.8rem; font-weight: 600; color: green;">Model Browser</h2>
            ...
            with gr.Tab("Generate with Model"):
                gr.Markdown(
                    """
                <div style="text-align: center; margin: 1rem 0;">
                    <h2 style="font-size: 1.8rem; font-weight: 600; color: green;">Image Generation</h2>
